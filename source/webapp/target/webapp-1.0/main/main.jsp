...
<body style="background: #fff;">
	...
	<header id="header"
		...
		<div id="logo" style="width: 80%; height: 32px;">
		...
		<div class="pull-right">
			...
			<div id="hide-menu" class="btn-header pull-right">
				<span> <a href="javascript:void(0);" data-action="toggleMenu"
					title="隐藏菜单"><i class="glyphicon glyphicon-align-justify"></i></a>
				</span>
			</div>
			<!-- end collapse menu -->
		</div>
	...
	<aside id="left-panel" style="background: #1559AC;">
		<div class="login-info" style="position: relative">
			<p id="welcome" style="margin-left: 15%; margin-top: 5%;">
				<span class="glyphicon glyphicon-star-empty"></span> <span>欢迎登陆</span>
				<a id="exist"
					style="display: inline-block; float: right; margin-right: 8px; margin-top: 0; color: #fff;"
			...
			<p id="loginUserNameCon" style="margin-left: 15%; cursor: pointer">
				<span class="glyphicon glyphicon-user"></span> <span
					id="loginUserName"> <!-- 用户名 --> ${userName}
				</span>

			</p>
			<p id="loginUserTimeCon" style="margin-left: 15%;">
				<span class="glyphicon glyphicon-time" style=""></span> 登陆时间：<span
					id="loginWeek"></span> <br /> <span id="loginUserTime"
					style="margin-left: 5%;"></span>
			</p>
		</div>
		 <nav>
		<ul id="tree" style="padding-left:15%">
		</ul>
		</nav>
	</aside>
	<!-- END NAVIGATION -->
	...
	<div class="containerAdd11"
		...
		<div
			style="position: relative; background: #fff; width: 65%; margin: 10% 17.5% 2% 25.5%; padding-bottom: 1%; height: 65%; overflow: auto;">
			<div
